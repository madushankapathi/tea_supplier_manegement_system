 ...
 * @author Madushanka
 */
public class pohora extends javax.swing.JFrame {

    /**
     * Creates new form pohora
     */
    public pohora() {
        initComponents();
        loadTable();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Pohora", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Tahoma", 1, 20), new java.awt.Color(0, 51, 204))); // NOI18N
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Table ID", "Customer ID", "Pohora", "Primium", "Balance", "Get date"
            }
        ) {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
            if(!id.isEmpty()){
                if (rs1.next()==true) {
                    String pohora = jTextField4.getText();
                    String primium = jTextField5.getText();
                    SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
                    String date = sdf.format(jDateChooser2.getDate()).toString();
                    DBMS.iud("INSERT INTO pohora(`c_id`,`pohora`,`primium`,`balance`,`get_date`,`up_date`) VALUES('"+id+"','"+pohora+"','"+primium+"','"+pohora+"','"+date+"','"+date+"')");
                    JOptionPane.showMessageDialog(this, "Pohora Add", "Success", JOptionPane.INFORMATION_MESSAGE);
                    loadTable();
                    jTextField3.setText("");
                    ...
                    JOptionPane.showMessageDialog(this, "Invalied Customer Id", "Add pohora", JOptionPane.INFORMATION_MESSAGE);
                    jTextField3.setText("");
                    jTextField4.setText("");
                    jTextField5.setText("");
                    jTextField3.grabFocus();
                ...
                JOptionPane.showMessageDialog(this, "Please Enter Id", "Add pohora", JOptionPane.INFORMATION_MESSAGE);
                jTextField3.setText("");
                jTextField4.setText("");
                jTextField5.setText("");
                jTextField3.grabFocus();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(row!=-1){
            ...
            JOptionPane.showMessageDialog(this, "Delete Selected Pohora", "Success", JOptionPane.INFORMATION_MESSAGE);
            loadTable();
        }else{
            JOptionPane.showMessageDialog(this, "Please Select Pohora", "Delete Pohora", JOptionPane.INFORMATION_MESSAGE);
        }
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        ResultSet rs1 = DBMS.search("SELECT * FROM pohora WHERE `c_id`='"+id+"' ");
        ...
        try {
            if(!id.isEmpty()){
                if(rs1.next()==true){
                    ResultSet rs2 = DBMS.search("SELECT * FROM pohora WHERE `c_id`='"+id+"' ");
                    while (rs2.next()) {                        
                    Vector<String> v = new Vector<>();
                    v.add(rs2.getString("id"));
                    v.add(rs2.getString("c_id"));
                    v.add(rs2.getString("pohora"));
                    ...
                    JOptionPane.showMessageDialog(this, "Invalid Id", "Search Pohora", JOptionPane.INFORMATION_MESSAGE);
                    jTextField7.setText("");
                    jTextField7.grabFocus();
                    loadTable();
                }
            }else{
                JOptionPane.showMessageDialog(this, "Please Enter Id", "Search Pohora", JOptionPane.INFORMATION_MESSAGE);
                jTextField7.setText("");
                jTextField7.grabFocus();
                loadTable();
            }
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if(row!=-1){
            ...
            String id = jTable1.getValueAt(row, 0).toString();
            String udate = null;
            ResultSet rs = DBMS.search("SELECT * FROM pohora WHERE `id`='"+id+"' ");
            if(rs.next()){
            ...
            JOptionPane.showMessageDialog(this, "Please Select Pohora", "Move Pohora To Loan", JOptionPane.INFORMATION_MESSAGE);
        }
        } catch (Exception e) {
            System.out.println(e);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pohora.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
try {
          ResultSet rs = DBMS.search("SELECT * FROM pohora ORDER BY CAST(id AS unsigned) DESC");
          TableModel tm = jTable1.getModel(); 
          DefaultTableModel dtm = (DefaultTableModel) tm;
          dtm.setRowCount(0);
