...
public class advance extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Advance", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Tahoma", 1, 20), new java.awt.Color(0, 51, 204))); // NOI18N
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Table ID", "Customer ID", "Adavance", "Primium", "Balance", "Get date"
            }
        ) {
        ...
        try{
            if(!id.isEmpty()){
                if (rs1.next()==true) {
                    ...
                    DBMS.iud("INSERT INTO advance(`c_id`,`adavance`,`primium`,`balance`,`get_date`,`up_date`) VALUES('"+id+"','"+advance+"','"+primium+"','"+advance+"','"+date+"','"+date+"')");
                    JOptionPane.showMessageDialog(this, "Advance Add", "Success", JOptionPane.INFORMATION_MESSAGE);
                    loadTable();
                    jTextField3.setText("");
                    ...
                    JOptionPane.showMessageDialog(this, "Invalied Customer Id", "Add advance", JOptionPane.INFORMATION_MESSAGE);
                    jTextField3.setText("");
                    jTextField4.setText("");
                    jTextField5.setText("");
                    jTextField3.grabFocus();
                ...
                JOptionPane.showMessageDialog(this, "Please Enter Id", "Add Advance", JOptionPane.INFORMATION_MESSAGE);
                jTextField3.setText("");
                jTextField4.setText("");
                jTextField5.setText("");
                jTextField3.grabFocus();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(row!=-1){
            ...
            JOptionPane.showMessageDialog(this, "Delete Selected Advance", "Success", JOptionPane.INFORMATION_MESSAGE);
            loadTable();
        }else{
            JOptionPane.showMessageDialog(this, "Please Select Advance", "Delete Advance", JOptionPane.INFORMATION_MESSAGE);
        }
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        ResultSet rs1 = DBMS.search("SELECT * FROM advance WHERE `c_id`='"+id+"' ");
        ...
        try {
            if(!id.isEmpty()){
                if(rs1.next()==true){
                    ResultSet rs2 = DBMS.search("SELECT * FROM advance WHERE `c_id`='"+id+"' ");
                    while(rs2.next()){
                    Vector<String> v = new Vector<>();
                   v.add(rs2.getString("id"));
              v.add(rs2.getString("c_id"));
              v.add(rs2.getString("adavance"));
              ...
              v.add(rs2.getString("get_date"));
                    ...
                    JOptionPane.showMessageDialog(this, "Invalid Id", "Search Advance", JOptionPane.INFORMATION_MESSAGE);
                    jTextField5.setText("");
                    jTextField5.grabFocus();
                    loadTable();
                }
            }else{
                JOptionPane.showMessageDialog(this, "Please Enter Id", "Search Advance", JOptionPane.INFORMATION_MESSAGE);
                jTextField5.setText("");
                jTextField5.grabFocus();
                loadTable();
            }
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try {
            ...
            if(row!=-1){
                ...
                String id = jTable1.getValueAt(row, 0).toString();
                String udate = null;
                ResultSet rs = DBMS.search("SELECT * FROM advance WHERE `id`='"+id+"' ");
                if(rs.next()){
                ...
                JOptionPane.showMessageDialog(this, "Please Select Advance", "Move Advance To Loan", JOptionPane.INFORMATION_MESSAGE);
            }
        } catch (Exception e) {
            System.out.println(e);
        }
...
try {
          ResultSet rs = DBMS.search("SELECT * FROM advance ORDER BY CAST(id AS unsigned) DESC");
          TableModel tm = jTable1.getModel(); 
          DefaultTableModel dtm = (DefaultTableModel) tm;
          dtm.setRowCount(0);
